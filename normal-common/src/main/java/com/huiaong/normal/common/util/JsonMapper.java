...
public class JsonMapper {
    ...
    public static final JsonMapper JSON_NON_NULL_MAPPER;
    ...
    static {
        ...
        JSON_NON_NULL_MAPPER = new JsonMapper(JsonInclude.Include.NON_NULL);
        JSON_ALWAYS_MAPPER = new JsonMapper(JsonInclude.Include.ALWAYS);
    }
