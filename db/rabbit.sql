...
-- ----------------------------
-- Table structure for normal_reliable_delivery
-- ----------------------------
DROP TABLE IF EXISTS `normal_reliable_delivery`;
CREATE TABLE `normal_reliable_delivery`  (
